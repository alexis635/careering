...
export interface WsItem { id: number; workspace_id: number; kind: string; title: string; body: string; due_on: string | null; done_at: string | null; extra: Record<string, string>; file_name?: string | null; size?: number | null; created_at: string; deleted_at?: string | null }
export interface Workspace { id: number; role_id: number; job_type: string; employer: string; title: string; start_date: string | null; end_date: string | null; responsibilities: string; wrapup: Record<string, boolean>; wrapped_up_at: string | null; created_at: string; deleted_at?: string | null; open_tasks?: number; items?: WsItem[]; gone?: WsItem[] }
