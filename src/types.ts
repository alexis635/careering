...
export interface WsItem { id: number; workspace_id: number; kind: string; title: string; body: string; due_on: string | null; done_at: string | null; extra: Record<string, string>; created_at: string; deleted_at?: string | null }
